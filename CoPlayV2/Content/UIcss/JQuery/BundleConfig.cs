...
namespace CoPlayV2
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //---------------------------------Stylesheet bundle starts here-------------------------------

            bundles.Add(new StyleBundle("~/bundles/layout/css").Include(
                "~/Content/UIcss/Bootstrap/bootstrap.css", // Bootstrap
            ...
            bundles.Add(new StyleBundle("~/bundles/uicss").Include(
                "~/Content/UIcss/Bootstrap/bootstrap.min.css",
            ...
            bundles.Add(new StyleBundle("~/bundles/jqueryUIcss").Include(
                "~/Content/UIcss/JQuery/jquery-ui.css"));
